...
public class PictureServiceImpl implements PictureService{
    ...
    @Override
    public Map<String, Object> uploadPicture(HttpServletRequest request, String FILE_PATH) {
        ...
        if (coMultiResolver.isMultipart(request)) {
            ...
            for (MultipartFile file : files) {
                if (!file.isEmpty()) { //这个判断必须要加
                    ...
                    resultMap.put("url", "upload/images/" + newfileName);
                    return resultMap;
                } else {//如果文件为空
                    //返回结果
                    resultMap.put("error", 1);
    ...
    @Override
    public Map<String, Object> deleteFile(String picName, HttpServletRequest request) {
